...
public class LoginActivity extends AppCompatActivity {
    ...
    public OnClickListener getlisten = new OnClickListener() {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(getlisten);
        reg.setOnClickListener(getlisten);
        forgot.setOnClickListener(getlisten);

        TextView shortcut = (TextView) findViewById(R.id.loginshortcut);
        shortcut.setOnClickListener(getlisten);
